...
namespace KZHDotNetCore.ConsoleAppRestClientExample;
...
internal class RestClientExample
{
    ...
    public async Task RunAsync()
    {
        //await ReadAsync();
        //await EditAsync(10);
        //await CreateAsync("TitleRestClient", "AuthorRestClient", "ContentRestClient");
        //await UpdateAsync(10, "TitleRestClientedited", "AuthorRestClientedited", "ContentRestClientedited");
        //await EditAsync(10);
    }
